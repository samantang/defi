...
<head>
 <meta charset="utf-8">
  ...
  <title>tech-clever - Accueil | Java</title>
...
<body>
  ...
  <header id="home">
    <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel"">
      <div class="carousel-inner">
        <div class="item active" style="background-image: url(<%=request.getContextPath()%>/resources/images/slider/1.jpg)">
          <div class="caption">
        ...
        <div class="item"  style="background-image: url(<%=request.getContextPath()%>/resources/images/slider/2.jpg)">
          <div class="caption">
        ...
        <div class="item" style="background-image: url(<%=request.getContextPath()%>/resources/images/slider/3.jpg)">
          <div class="caption">
            <h1 class="animated fadeInLeftBig">Nous y <span>arriverons</span></h1>
            <p class="animated fadeInRightBig">Bootstrap - Responsive Design - Retina Ready - Parallax</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">                 
            ...
            <li class="scroll"><a href="#about-us">Comment ça marche</a></li> 
            <!-- <li class="scroll"><a href="#portfolio">Portfolio</a></li>
            <li class="scroll"><a href="#team">Team</a></li>
            <li class="scroll"><a href="#blog">Blog</a></li>  -->
            <li class="scroll"><a href="#contact">Contact</a></li> 
            <li class="scroll"><a href="testInscription">Inscription</a></li>       
          </ul>
        ...
        <div class="row">
          <div class="col-sm-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
            <div class="post-thumb">
              <a href="#"><img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/blog/1.jpg" alt=""></a> 
              <div class="post-meta">
              ...
              <div id="post-carousel"  class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    <a href="#"><img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/blog/2.jpg" alt=""></a>
                  </div>
                  <div class="item">
                    <a href="#"><img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/blog/1.jpg" alt=""></a>
                  </div>
                  <div class="item">
                    <a href="#"><img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/blog/3.jpg" alt=""></a>
                  </div>
                </div>                               
  ...
  <footer id="footer">
    <div class="footer-top wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
      <div class="container text-center">
        <div class="footer-logo">
          <a href="index.html"><img class="img-responsive" src="<%=request.getContextPath()%>/resources/images/logo.png" alt=""></a>
        </div>
        <div class="social-icons">
          <ul>
    ...
    <div class="modal fade" id="formulaireInscription" tabindex="-1" role="dialog"  aria-labelledby="formulaireInscription" aria-hidden="true">
