													 			...
													 			<table class="table table-bordered table-striped table-condensed">
													 				...
													 				<tr>
													 					...
													 					<c:forEach items="${paysRestants}" var="e">
															 				<tr>
															 					<td style="border: 1px solid black;"><c:out value="${e.pays}"></c:out></td>
															 				</tr>
													 					</c:forEach>
													 			</table>
													 			</c:if>
													 			...
													 			<div class="col-md-6 col-lg-6"> 
														 			<c:if test="${not empty capitalesRestantes}">
															 			<table class="table table-bordered table-striped table-condensed">
															 				...
															 				<tr>
															 					<td style="border: 1px solid black;"><c:out value="${e.capitale}"></c:out></td>
															 				</tr>
															 					</c:forEach>
															 			</table>
														 			</c:if>
													...
													<div class="panel-body">
													 		...
													 		<div class="col-md-6 col-lg-6">
													 			...
													 			<table class="table table-bordered table-striped table-condensed">
													 				...
													 				<tr>
													 					<td style="border: 1px solid black;"><c:out value="${e.nom}"></c:out></td>
													 				</tr>
													 					</c:forEach>
													 			</table>
													 			</c:if>
