...
<body>
					<div class="resultatGagnant">Bravo à vous, vous avez trouvez tout le mot ${motComplet} et obtenu un score de ${points}/${scoreMax} avec <c:out value="${nbErreurs}"></c:out> erreurs,
